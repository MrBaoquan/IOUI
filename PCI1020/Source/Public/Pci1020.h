...
/***************************************************************/
// 轴号
#define		PCI1020_XAXIS			0X0				// X轴
#define		PCI1020_YAXIS			0x1				// Y轴
#define		PCI1020_ZAXIS			0x2				// Z轴
#define		PCI1020_UAXIS			0x3				// U轴
#define		PCI1020_ALLAXIS			0xF				// 所有轴

/***************************************************************/
// 驱动方式
#define		PCI1020_DV				0x0				// 定长驱动
#define		PCI1020_LV				0x1				// 连续驱动

/***************************************************************/
// 减速方式
#define		PCI1020_AUTO			0x0				// 自动减速
#define		PCI1020_HAND			0x1				// 手动减速

/***************************************************************/
// 脉冲输出方式
#define 	PCI1020_CWCCW			0X0				// CW/CCW方式 
#define 	PCI1020_CPDIR 			0X1				// CP/DIR方式

/***************************************************************/
// 脉冲输入方式
#define 	PCI1020_A_B			    0X0				// A/B相方式
#define 	PCI1020_U_D 			0X1				// 上/下脉冲输入方式

/***************************************************************/
// 运动方式
#define		PCI1020_LINE			0X0				// 直线运动
#define		PCI1020_CURVE			0X1				// S曲线运动

/***************************************************************/
// 运动方向
#define		PCI1020_MDIRECTION		0x0				// 反方向
#define		PCI1020_PDIRECTION		0x1				// 正方向

/***************************************************************/
//固定线速度
#define		PCI1020_NOCONSTAND		0X0				// 不固定线速度
#define		PCI1020_CONSTAND		0X1				// 固定线速度

/***************************************************************/
// 软件限位的逻辑实位计数器选择和设置外部越限信号的停止方式和设置外部停止信号的停止号选择
/***************************************************************/
// 计数器类别
#define		PCI1020_LOGIC			0x0				// 逻辑位计数器
#define		PCI1020_FACT			0x1				// 实位计数器

/***************************************************************/
// 外部停止信号
#define 	PCI1020_IN0				0X0				// 停止信号0
#define 	PCI1020_IN1				0X1				// 停止信号1
#define 	PCI1020_IN2				0X2				// 停止信号2
#define 	PCI1020_IN3				0X3				// 停止信号3

/***************************************************************/
// 停止方式
#define		PCI1020_SUDDENSTOP		0x0				// 立即停止
#define		PCI1020_DECSTOP			0X1				// 减速停止

/********************************************************************/
// 输出切换
#define		PCI1020_GENERALOUT		0x0				// 通用输出
#define		PCI1020_STATUSOUT		0X1				// 状态输出

/********************************************************************/
#define		PCI1020_ERROR			0XFF			// 错误
...
extern "C" {
	...
	//######################## 设备对象管理函数 #################################
	// 适用于本设备的最基本操作	
	HANDLE DEVAPI FAR PASCAL PCI1020_CreateDevice(       // 创建句柄
								int DeviceID);           // 设备ID号

	int DEVAPI FAR PASCAL PCI1020_GetDeviceCount(        // 获得设备总数
								HANDLE hDevice);		 // 设备句柄

	BOOL DEVAPI FAR PASCAL PCI1020_ReleaseDevice(		 // 释放设备
								HANDLE hDevice);		 // 设备句柄

	BOOL DEVAPI FAR PASCAL PCI1020_Reset(				 // 软件复位
								HANDLE hDevice);		 // 设备句柄
	//*******************************************************************
	// 设置电机的逻辑计数器、实际位置计数器、加速计数器偏移

	BOOL DEVAPI FAR PASCAL PCI1020_PulseOutMode(         // 设置脉冲输出模式
								HANDLE hDevice,			 // 设备句柄
								LONG AxisNum,			 // 轴号(PCI1020_XAXIS:X轴,PCI1020_YAXIS:Y轴, PCI1020_ZAXIS:Z轴,PCI1020_UAXIS:U轴)  
								LONG Mode);				 // 模式

	BOOL DEVAPI FAR PASCAL PCI1020_PulseInputMode(       // 设置脉冲输入模式
								HANDLE hDevice,			 // 设备句柄
								LONG AxisNum,			 // 轴号(PCI1020_XAXIS:X轴,PCI1020_YAXIS:Y轴, PCI1020_ZAXIS:Z轴,PCI1020_UAXIS:U轴)  
								LONG Mode);				 // 模式

	BOOL DEVAPI FAR PASCAL PCI1020_SetR(				 // 设置倍率(1-500)	
								HANDLE hDevice,			 // 设备句柄
								LONG AxisNum,			 // 轴号(PCI1020_XAXIS:X轴,PCI1020_YAXIS:Y轴, PCI1020_ZAXIS:Z轴,PCI1020_UAXIS:U轴)  
								LONG Data);				 // 倍率值(1-500)

	BOOL DEVAPI FAR PASCAL PCI1020_SetA(				 // 设置加速度
								HANDLE hDevice,			 // 设备句柄
								LONG AxisNum,			 // 轴号(PCI1020_XAXIS:X轴,PCI1020_YAXIS:Y轴, PCI1020_ZAXIS:Z轴,PCI1020_UAXIS:U轴)     
								LONG Data);				 // 加速度 (125-1000000)

	BOOL DEVAPI FAR PASCAL PCI1020_SetDec(				 // 设置减速度
								HANDLE hDevice,			 // 设备句柄
								LONG AxisNum,			 // 轴号(PCI1020_XAXIS:X轴,PCI1020_YAXIS:Y轴, PCI1020_ZAXIS:Z轴,PCI1020_UAXIS:U轴) 
								LONG Data);				 // 减速度值(125-1000,000)

	BOOL DEVAPI FAR PASCAL PCI1020_SetAccIncRate(		 // 加速度变化率  
								HANDLE hDevice,			 // 设备句柄
								LONG AxisNum,			 // 轴号(PCI1020_XAXIS:X轴,PCI1020_YAXIS:Y轴, PCI1020_ZAXIS:Z轴,PCI1020_UAXIS:U轴)   
								LONG Data);				 // 数据 (954-62500000) 

	BOOL DEVAPI FAR PASCAL PCI1020_SetDecIncRate(		 // 减速度变化率  
								HANDLE hDevice,			 // 设备句柄
								LONG AxisNum,			 // 轴号(PCI1020_XAXIS:X轴,PCI1020_YAXIS:Y轴, PCI1020_ZAXIS:Z轴,PCI1020_UAXIS:U轴) 
								LONG Data);				 // 数据 (954-62500000)

	BOOL DEVAPI FAR PASCAL PCI1020_SetSV(				 // 设置初始速度(1-8000)
								HANDLE hDevice,			 // 设备句柄
								LONG AxisNum,			 // 轴号(PCI1020_XAXIS:X轴,PCI1020_YAXIS:Y轴, PCI1020_ZAXIS:Z轴,PCI1020_UAXIS:U轴)   
								LONG Data);				 // 速度值(1-8000)

	BOOL DEVAPI FAR PASCAL PCI1020_SetV(				 // 设置驱动速度
								HANDLE hDevice,			 // 设备句柄
								LONG AxisNum,			 // 轴号(PCI1020_XAXIS:X轴,PCI1020_YAXIS:Y轴, PCI1020_ZAXIS:Z轴,PCI1020_UAXIS:U轴)     
								LONG Data);				 // 驱动速度值(1-8000)

	BOOL DEVAPI FAR PASCAL PCI1020_SetHV(				 // 设置原点搜寻速度
								HANDLE hDevice,			 // 设备句柄
								LONG AxisNum,			 // 轴号(PCI1020_XAXIS:X轴,PCI1020_YAXIS:Y轴, PCI1020_ZAXIS:Z轴,PCI1020_UAXIS:U轴)	
								LONG Data);				 // 原点搜寻速度值(1-8000)

	BOOL DEVAPI FAR PASCAL PCI1020_SetP(				 // 设置定长脉冲数
								HANDLE hDevice,			 // 设备句柄
								LONG AxisNum,			 // 轴号(PCI1020_XAXIS:X轴,PCI1020_YAXIS:Y轴, PCI1020_ZAXIS:Z轴,PCI1020_UAXIS:U轴) 
								LONG Data);			     // 定长脉冲数(0-268435455)

	BOOL DEVAPI FAR PASCAL PCI1020_SetIP(				 // 设置插补终点脉冲数(-8388608-+8388607)
								HANDLE hDevice,			 // 设备句柄
								LONG AxisNum,			 // 轴号(PCI1020_XAXIS:X轴,PCI1020_YAXIS:Y轴, PCI1020_ZAXIS:Z轴,PCI1020_UAXIS:U轴) 
								LONG Data);				 // 插补终点脉冲数(-8388608-+8388607)

	BOOL DEVAPI FAR PASCAL PCI1020_SetC(                 // 设置圆心坐标(脉冲数)  
								HANDLE hDevice,			 // 设备句柄
								LONG AxisNum,			 // 轴号(PCI1020_XAXIS:X轴,PCI1020_YAXIS:Y轴, PCI1020_ZAXIS:Z轴,PCI1020_UAXIS:U轴) 
								LONG Data);				 // 圆心坐标脉冲数范围(-2147483648-+2147483647)

	BOOL DEVAPI FAR PASCAL PCI1020_SetLP(				 // 设置逻辑位置计数器
								HANDLE hDevice,			 // 设备句柄
								LONG AxisNum,			 // 轴号(PCI1020_XAXIS:X轴,PCI1020_YAXIS:Y轴, PCI1020_ZAXIS:Z轴,PCI1020_UAXIS:U轴) 
								LONG Data);				 // 逻辑位置计数器值(-2147483648-+2147483647)

	BOOL DEVAPI FAR PASCAL PCI1020_SetEP(				 // 设置实位计数器 
								HANDLE hDevice,			 // 设备句柄
								LONG AxisNum,			 // 轴号(PCI1020_XAXIS:X轴,PCI1020_YAXIS:Y轴, PCI1020_ZAXIS:Z轴,PCI1020_UAXIS:U轴) 
								LONG Data);				 // 实位计数器值(-2147483648-+2147483647)

	BOOL DEVAPI FAR PASCAL PCI1020_SetAccofst(			 // 设置加速计数器偏移
								HANDLE hDevice,			 // 设备句柄
								LONG AxisNum,			 // 轴号(PCI1020_XAXIS:X轴,PCI1020_YAXIS:Y轴, PCI1020_ZAXIS:Z轴,PCI1020_UAXIS:U轴) 
								LONG Data);				 // 偏移范围(0-65535)

	BOOL DEVAPI FAR PASCAL PCI1020_SelectLPEP(			 // 选择逻辑计数器或实位计数器
								HANDLE hDevice,			 // 设备句柄
								LONG AxisNum,			 // 轴号(PCI1020_XAXIS:X轴,PCI1020_YAXIS:Y轴, PCI1020_ZAXIS:Z轴,PCI1020_UAXIS:U轴) 
								LONG LogicFact);		 // 选择逻辑位置计数器或实位计数器 PCI1020_LOGIC：逻辑位置计数器 PCI1020_FACT：实位计数器	

	BOOL DEVAPI FAR PASCAL PCI1020_SetCOMPP(			 // 设置COMP+寄存器
								HANDLE hDevice,			 // 设备号
								LONG AxisNum,			 // 轴号(PCI1020_XAXIS:X轴,PCI1020_YAXIS:Y轴, PCI1020_ZAXIS:Z轴,PCI1020_UAXIS:U轴)  
								USHORT LogicFact,		 // 选择逻辑位置计数器或实位计数器 PCI1020_LOGIC：逻辑位置计数器 PCI1020_FACT：实位计数器	
								LONG Data);

	BOOL DEVAPI FAR PASCAL PCI1020_SetCOMPM(			 // 设置COMP-寄存器
								HANDLE hDevice,			 // 设备号
								LONG AxisNum,			 // 轴号(PCI1020_XAXIS:X轴,PCI1020_YAXIS:Y轴, PCI1020_ZAXIS:Z轴,PCI1020_UAXIS:U轴) 
								USHORT LogicFact,		 // 选择逻辑位置计数器或实位计数器 PCI1020_LOGIC：逻辑位置计数器 PCI1020_FACT：实位计数器	
								LONG Data);
	//*******************************************************************
	// 设置同步位
	BOOL DEVAPI FAR PASCAL PCI1020_SetSynchronAction(	 // 设置同步位
								HANDLE hDevice,			 // 设备句柄
								LONG AxisNum,			 // 轴号(PCI1020_XAXIS:X轴,PCI1020_YAXIS:Y轴, PCI1020_ZAXIS:Z轴,PCI1020_UAXIS:U轴) 
								PPCI1020_PARA_SynchronActionOwnAxis pPara1,// 自己轴的参数设置
								PPCI1020_PARA_SynchronActionOtherAxis pPara2);// 其它轴的参数设置

	BOOL DEVAPI FAR PASCAL PCI1020_SynchronActionDisable(// 设置同步位无效
								HANDLE hDevice,			 // 设备句柄
								LONG AxisNum,			 // 轴号(PCI1020_XAXIS:X轴,PCI1020_YAXIS:Y轴, PCI1020_ZAXIS:Z轴,PCI1020_UAXIS:U轴)
								PPCI1020_PARA_SynchronActionOwnAxis pPara1,// 自己轴的参数设置
								PPCI1020_PARA_SynchronActionOtherAxis pPara2);// 其它轴的参数设置

	BOOL DEVAPI FAR PASCAL PCI1020_WriteSynchronActionCom(// 写同步操作命令
								HANDLE hDevice,			 // 设备句柄
								LONG AxisNum);			 // 轴号(PCI1020_XAXIS:X轴,PCI1020_YAXIS:Y轴, PCI1020_ZAXIS:Z轴,PCI1020_UAXIS:U轴) 

	//*******************************************************************
	//  设置DCC和其他模式
	BOOL DEVAPI FAR PASCAL PCI1020_SetDCC(				 // 设置输出信号nDCC的输出电平和电平宽度
								HANDLE hDevice,			 // 设备句柄
								LONG AxisNum,			 // 轴号(PCI1020_XAXIS:X轴,PCI1020_YAXIS:Y轴, PCI1020_ZAXIS:Z轴,PCI1020_UAXIS:U轴) 
								PPCI1020_PARA_DCC pPara);// DCC信号参数结构体指针

	BOOL DEVAPI FAR PASCAL PCI1020_StartDCC(			   // 启动偏离计数器清除输出命令
								HANDLE hDevice,			   // 设备句柄
								LONG AxisNum);			   // 轴号(PCI1020_XAXIS:X轴,PCI1020_YAXIS:Y轴, PCI1020_ZAXIS:Z轴,PCI1020_UAXIS:U轴) 

	BOOL DEVAPI FAR PASCAL PCI1020_ExtMode(				   // 设置其他模式
								HANDLE hDevice,			   // 设备句柄
								LONG AxisNum,			   // 轴号(PCI1020_XAXIS:X轴,PCI1020_YAXIS:Y轴, PCI1020_ZAXIS:Z轴,PCI1020_UAXIS:U轴) 
								PPCI1020_PARA_ExpMode pPara);// 其他参数结构体指针
	//*******************************************************************
	// 设置自动原点搜寻
	BOOL DEVAPI FAR PASCAL PCI1020_SetInEnable(			// 设置自动原点搜寻第一、第二、第三步外部触发信号IN0-2的有效电平
								HANDLE hDevice,			// 设备号
								LONG AxisNum,			// 轴号(PCI1020_XAXIS:X轴,PCI1020_YAXIS:Y轴, PCI1020_ZAXIS:Z轴,PCI1020_UAXIS:U轴)	
								LONG InNum,				// 停止号
								LONG LogLever);			// 有效电平

	BOOL DEVAPI FAR PASCAL PCI1020_SetAutoHomeSearch(   // 设置自动原点搜寻参数
								HANDLE hDevice,			// 设备句柄
								LONG AxisNum,			// 轴号(PCI1020_XAXIS:X轴,PCI1020_YAXIS:Y轴, PCI1020_ZAXIS:Z轴,PCI1020_UAXIS:U轴)
								PPCI1020_PARA_AutoHomeSearch pPara);// 自动搜寻原点参数结构体指针

	BOOL DEVAPI FAR PASCAL PCI1020_StartAutoHomeSearch( // 启动自动原点搜寻
								HANDLE hDevice,			// 设备句柄		
								LONG AxisNum);			// 轴号(1:X轴; 2:Y轴)	

	//*******************************************************************
	// 设置编码器输入信号类型
	BOOL DEVAPI FAR PASCAL PCI1020_SetEncoderSignalType(// 设置编码器输入信号类型
								HANDLE hDevice,			// 设备句柄
								LONG AxisNum,			// 轴号(PCI1020_XAXIS:X轴,PCI1020_YAXIS:Y轴, PCI1020_ZAXIS:Z轴,PCI1020_UAXIS:U轴)	
	...
	//*******************************************************************
	// 直线S曲线初始化、启动函数
	BOOL DEVAPI FAR PASCAL PCI1020_InitLVDV(				// 初始化连续,定长脉冲驱动
								HANDLE hDevice,				// 设备句柄
								PPCI1020_PARA_DataList pDL, // 公共参数结构体指针
								PPCI1020_PARA_LCData pLC);	// 直线S曲线参数结构体指针

	BOOL DEVAPI FAR PASCAL PCI1020_StartLVDV(				// 启动连续,定长脉冲驱动
								HANDLE hDevice,				// 设备句柄
								LONG AxisNum);				// 轴号(PCI1020_XAXIS:X轴,PCI1020_YAXIS:Y轴, PCI1020_ZAXIS:Z轴,PCI1020_UAXIS:U轴) 

	BOOL DEVAPI FAR PASCAL	PCI1020_Start4D(HANDLE hDevice);// 4轴同时启动						           
	//*******************************************************************
	// 任意2轴直线插补初始化、启动函数
	BOOL DEVAPI FAR PASCAL PCI1020_InitLineInterpolation_2D(// 初始化任意2轴直线插补运动 
								HANDLE hDevice,				// 设备句柄
								PPCI1020_PARA_DataList pDL, // 公共参数结构体指针
								PPCI1020_PARA_InterpolationAxis pIA,// 插补轴结构体指针
								PPCI1020_PARA_LineData pLD);// 直线插补结构体指针

	BOOL DEVAPI FAR PASCAL PCI1020_StartLineInterpolation_2D(// 启动任意2轴直线插补运动 
								HANDLE hDevice);			 // 设备句柄
								
	//*******************************************************************
	// 任意3轴直线插补初始化、启动函数
	BOOL DEVAPI FAR PASCAL PCI1020_InitLineInterpolation_3D(// 初始化任意3轴直线插补运动	
								HANDLE hDevice,				// 设备句柄
								PPCI1020_PARA_DataList pDL, // 公共参数结构体指针
								PPCI1020_PARA_InterpolationAxis pIA,// 插补轴结构体指针
								PPCI1020_PARA_LineData pLD);// 直线插补结构体指针

	BOOL DEVAPI FAR PASCAL PCI1020_StartLineInterpolation_3D(// 启动任意3轴直线插补运动 				
								HANDLE hDevice);			 // 设备句柄
		
	//*******************************************************************
	// 任意2轴正反方向圆弧插补初始化、启动函数
	BOOL DEVAPI FAR PASCAL PCI1020_InitCWInterpolation_2D(	// 初始化任意2轴正反方向圆弧插补运动 
								HANDLE hDevice,				// 设备句柄
								PPCI1020_PARA_DataList pDL, // 公共参数结构体指针
								PPCI1020_PARA_InterpolationAxis pIA,// 插补轴结构体指针
								PPCI1020_PARA_CircleData pCD);// 圆弧插补结构体指针
	                         
	BOOL DEVAPI FAR PASCAL PCI1020_StartCWInterpolation_2D( // 启动任意2轴正、反方向圆弧插补运动 
								HANDLE hDevice,				// 设备句柄
								LONG Direction);			// 方向 正转：PCI1020_PDIRECTION 反转：PCI1020_MDIRECTION                     
	//*************************************************************************
	// 位插补相关函数
	BOOL DEVAPI FAR PASCAL PCI1020_InitBitInterpolation_2D(	// 初始化任意2轴位插补参数
								HANDLE hDevice,				// 设备句柄
								PPCI1020_PARA_InterpolationAxis pIA,// 插补轴结构体指针
								PPCI1020_PARA_DataList pDL);// 公共参数结构体指针

	BOOL DEVAPI FAR PASCAL PCI1020_InitBitInterpolation_3D(// 初始化任意2轴位插补参数
								HANDLE hDevice,			   // 设备句柄
								PPCI1020_PARA_InterpolationAxis pIA,// 插补轴结构体指针
								PPCI1020_PARA_DataList pDL);// 公共参数结构体指针

	BOOL DEVAPI FAR PASCAL PCI1020_AutoBitInterpolation_2D( // 启动任意2轴位插补子线程
								HANDLE hDevice,				// 设备句柄
								PUSHORT pBuffer,				// 位插补数据指针	
								UINT nCount);				// 数据组数

	BOOL DEVAPI FAR PASCAL PCI1020_AutoBitInterpolation_3D( // 启动任意3轴位插补子线程
								HANDLE hDevice,				// 设备句柄
								PSHORT pBuffer,				// 位插补数据指针	
								UINT nCount);				// 数据组数

	BOOL DEVAPI FAR PASCAL PCI1020_ReleaseBitInterpolation(	// 释放BP寄存器
								HANDLE hDevice);			// 设备句柄

	BOOL DEVAPI FAR PASCAL PCI1020_SetBP_2D(                // 设置任意2轴位插补数据
								HANDLE hDevice,				// 设备句柄 
	...
	BOOL DEVAPI FAR PASCAL PCI1020_SetBP_3D(				// 设置任意3轴位插补数据	
								HANDLE hDevice,				// 设备句柄
	...
	LONG DEVAPI FAR PASCAL PCI1020_BPRegisterStack(			// BP位数据堆栈返回值
								HANDLE hDevice);			// 设备句柄

	BOOL DEVAPI FAR PASCAL PCI1020_StartBitInterpolation_2D(// 启动任意2轴位插补
								HANDLE hDevice);			// 设备句柄

	BOOL DEVAPI FAR PASCAL PCI1020_StartBitInterpolation_3D(// 启动任意3轴位插补
								HANDLE hDevice);			// 设备句柄

	BOOL DEVAPI FAR PASCAL  PCI1020_BPWait(					// 等待位插补的下一个数据设定
								HANDLE hDevice);			// 设备句柄

	BOOL DEVAPI FAR PASCAL PCI1020_ClearBPData(				// 清除BP寄存器数据
								HANDLE hDevice);			// 设备句柄
	//*******************************************************************
	// 连续插补相关函数
								
	BOOL DEVAPI FAR PASCAL  PCI1020_NextWait(				// 等待连续插补下一个节点命令设定
								HANDLE hDevice);			// 设备句柄

	//*******************************************************************
	// 单步插补函数
	BOOL DEVAPI FAR PASCAL PCI1020_SingleStepInterpolationCom(// 设置命令控制单步插补运动
								HANDLE hDevice);			// 设备句柄	

	BOOL DEVAPI FAR PASCAL PCI1020_StartSingleStepInterpolation(// 发单步命令
								HANDLE hDevice);

	BOOL DEVAPI FAR PASCAL PCI1020_SingleStepInterpolationExt(// 设置外部控制单步插补运动
								HANDLE hDevice);			// 设备句柄

	BOOL DEVAPI FAR PASCAL PCI1020_ClearSingleStepInterpolation(// 清除单步插补设置
								HANDLE hDevice);			// 设备句柄
	//*******************************************************************
	// 中断位设置、插补中断状态清除
	BOOL DEVAPI FAR PASCAL PCI1020_SetInterruptBit(			// 设置中断位
								HANDLE hDevice,				// 设备句柄
								LONG AxisNum,				// 轴号(PCI1020_XAXIS:X轴,PCI1020_YAXIS:Y轴, PCI1020_ZAXIS:Z轴,PCI1020_UAXIS:U轴) 
								PPCI1020_PARA_Interrupt pPara);// 中断位结构体指针

	BOOL DEVAPI FAR PASCAL PCI1020_ClearInterruptStatus(	// 清除插补中断状态 
								HANDLE hDevice);			// 设备句柄

	//*******************************************************************
	// 外部信号启动电机定长驱动、连续驱动

	BOOL DEVAPI FAR PASCAL PCI1020_SetOutEnableDV(		 // 设置外部使能定量驱动(下降沿有效)
								HANDLE hDevice,			 // 设备句柄
								LONG AxisNum);			 // 轴号(PCI1020_XAXIS:X轴,PCI1020_YAXIS:Y轴, PCI1020_ZAXIS:Z轴,PCI1020_UAXIS:U轴) 
			                    
	BOOL DEVAPI FAR PASCAL PCI1020_SetOutEnableLV(		 // 设置外部使能连续驱动(保持低电平有效)
								HANDLE hDevice,			 // 设备句柄
								LONG AxisNum);			 // 轴号(PCI1020_XAXIS:X轴,PCI1020_YAXIS:Y轴, PCI1020_ZAXIS:Z轴,PCI1020_UAXIS:U轴) 

	//*******************************************************************
	// 设置软件限位有效和无效
	BOOL DEVAPI FAR PASCAL PCI1020_SetPDirSoftwareLimit( // 设置正方向软件限位
								HANDLE hDevice,			 // 设备句柄
								LONG AxisNum,			 // 轴号(PCI1020_XAXIS:X轴,PCI1020_YAXIS:Y轴, PCI1020_ZAXIS:Z轴,PCI1020_UAXIS:U轴) 
								LONG LogicFact,			 // 逻辑/实位计数器选择 PCI1020_LOGIC：逻辑位置计数器 PCI1020_FACT：实位计数器	
								LONG Data);				 // 软件限位数据

	BOOL DEVAPI FAR PASCAL PCI1020_SetMDirSoftwareLimit( // 设置反方向软件限位
								HANDLE hDevice,			 // 设备句柄
								LONG AxisNum,			 // 轴号(PCI1020_XAXIS:X轴,PCI1020_YAXIS:Y轴, PCI1020_ZAXIS:Z轴,PCI1020_UAXIS:U轴) 
								LONG LogicFact,			 // 逻辑/实位计数器选择 PCI1020_LOGIC：逻辑位置计数器 PCI1020_FACT：实位计数器	
								LONG Data);				 

	BOOL DEVAPI FAR PASCAL PCI1020_ClearSoftwareLimit(	 // 清除软件限位
								HANDLE hDevice,			 // 设备句柄
								LONG AxisNum);			 // 轴号(PCI1020_XAXIS:X轴,PCI1020_YAXIS:Y轴, PCI1020_ZAXIS:Z轴,PCI1020_UAXIS:U轴)

	//******************************************************************* 
	// 设置外部输入信号的有效和无效		
	BOOL DEVAPI FAR PASCAL PCI1020_SetLMTEnable(		 // 设置外部越限信号的有效及停止方式	
								HANDLE hDevice,			 // 设备句柄
								LONG AxisNum,			 // 轴号(PCI1020_XAXIS:X轴,PCI1020_YAXIS:Y轴, PCI1020_ZAXIS:Z轴,PCI1020_UAXIS:U轴) 
								LONG StopMode);          // PCI1020_DECSTOP：减速停止，PCI1020_SUDDENSTOP：立即停止

	BOOL DEVAPI FAR PASCAL PCI1020_SetStopEnable(		 // 设置外部停止信号有效
								HANDLE hDevice,			 // 设备句柄
								LONG AxisNum,			 // 轴号(PCI1020_XAXIS:X轴,PCI1020_YAXIS:Y轴, PCI1020_ZAXIS:Z轴,PCI1020_UAXIS:U轴) 
								LONG StopNum);			 // 停止号

	BOOL DEVAPI FAR PASCAL PCI1020_SetStopDisable(		 // 设置外部停止信号无效
								HANDLE hDevice,			 // 设备句柄
								LONG AxisNum,			 // 轴号(PCI1020_XAXIS:X轴,PCI1020_YAXIS:Y轴, PCI1020_ZAXIS:Z轴,PCI1020_UAXIS:U轴)
								LONG StopNum);			 // 停止号
												
	BOOL DEVAPI FAR PASCAL PCI1020_SetALARMEnable(       // 设置伺服报警信号有效 
								HANDLE hDevice,			 // 设备句柄
								LONG AxisNum);			 // 轴号(PCI1020_XAXIS:X轴,PCI1020_YAXIS:Y轴, PCI1020_ZAXIS:Z轴,PCI1020_UAXIS:U轴)  

	BOOL DEVAPI FAR PASCAL PCI1020_SetALARMDisable(      // 设置伺服报警信号无效  
								HANDLE hDevice,			 // 设备句柄
								LONG AxisNum);			 // 轴号(PCI1020_XAXIS:X轴,PCI1020_YAXIS:Y轴, PCI1020_ZAXIS:Z轴,PCI1020_UAXIS:U轴)  

	BOOL DEVAPI FAR PASCAL PCI1020_SetINPOSEnable(		 // 设置伺服马达定位完毕输入信号有效 
								HANDLE hDevice,			 // 设备句柄	
								LONG AxisNum);			 // 轴号(PCI1020_XAXIS:X轴,PCI1020_YAXIS:Y轴, PCI1020_ZAXIS:Z轴,PCI1020_UAXIS:U轴) 

	BOOL DEVAPI FAR PASCAL PCI1020_SetINPOSDisable(		 // 设置伺服马达定位完毕输入信号无效
								HANDLE hDevice,			 // 设备句柄
								LONG AxisNum);			 // 轴号(PCI1020_XAXIS:X轴,PCI1020_YAXIS:Y轴, PCI1020_ZAXIS:Z轴,PCI1020_UAXIS:U轴) 
	...
	BOOL DEVAPI FAR PASCAL PCI1020_DecValid(			 // 减速有效
								HANDLE hDevice);		 // 设备句柄

	BOOL DEVAPI FAR PASCAL PCI1020_DecInvalid(			 // 减速无效
								HANDLE hDevice);		 // 设备句柄

	BOOL DEVAPI FAR PASCAL PCI1020_DecStop(				 // 减速停止
								HANDLE hDevice,			 // 设备句柄
								LONG AxisNum);			 // 轴号(PCI1020_XAXIS:X轴,PCI1020_YAXIS:Y轴, PCI1020_ZAXIS:Z轴,PCI1020_UAXIS:U轴)  

	BOOL DEVAPI FAR PASCAL PCI1020_InstStop(			 // 立即停止
								HANDLE hDevice,			 // 设备句柄
								LONG AxisNum);			 // 轴号(PCI1020_XAXIS:X轴,PCI1020_YAXIS:Y轴, PCI1020_ZAXIS:Z轴,PCI1020_UAXIS:U轴) 

	BOOL DEVAPI FAR PASCAL PCI1020_AutoDec(				 // 自动减速
								HANDLE hDevice,			 // 设备句柄
								LONG AxisNum);			 // 轴号(PCI1020_XAXIS:X轴,PCI1020_YAXIS:Y轴, PCI1020_ZAXIS:Z轴,PCI1020_UAXIS:U轴) 

	BOOL DEVAPI FAR PASCAL PCI1020_HanDec(				 // 手动减速点设定
								HANDLE hDevice,			 // 设备句柄
								LONG AxisNum,			 // 轴号(PCI1020_XAXIS:X轴,PCI1020_YAXIS:Y轴, PCI1020_ZAXIS:Z轴,PCI1020_UAXIS:U轴) 
	...
	LONG DEVAPI FAR PASCAL PCI1020_ReadLP(				 // 读逻辑计数器
								HANDLE hDevice,			 // 设备句柄
								LONG AxisNum);			 // 轴号(PCI1020_XAXIS:X轴,PCI1020_YAXIS:Y轴, PCI1020_ZAXIS:Z轴,PCI1020_UAXIS:U轴) 

	LONG DEVAPI FAR PASCAL PCI1020_ReadEP(				 // 读实位计数器
								HANDLE hDevice,			 // 设备句柄
								LONG AxisNum);			 // 轴号(PCI1020_XAXIS:X轴,PCI1020_YAXIS:Y轴, PCI1020_ZAXIS:Z轴,PCI1020_UAXIS:U轴) 

	LONG DEVAPI FAR PASCAL PCI1020_ReadBR(				 // 读同步缓冲寄存器
								HANDLE hDevice,			 // 设备句柄
								LONG AxisNum);			 // 轴号(PCI1020_XAXIS:X轴,PCI1020_YAXIS:Y轴, PCI1020_ZAXIS:Z轴,PCI1020_UAXIS:U轴)

	LONG DEVAPI FAR PASCAL PCI1020_ReadCV(				 // 读当前速度
								HANDLE hDevice,			 // 设备句柄
								LONG AxisNum);			 // 轴号(PCI1020_XAXIS:X轴,PCI1020_YAXIS:Y轴, PCI1020_ZAXIS:Z轴,PCI1020_UAXIS:U轴) 

	LONG DEVAPI FAR PASCAL PCI1020_ReadCA(				 // 读当前加速度
								HANDLE hDevice,			 // 设备句柄
								LONG AxisNum);			 // 轴号(PCI1020_XAXIS:X轴,PCI1020_YAXIS:Y轴, PCI1020_ZAXIS:Z轴,PCI1020_UAXIS:U轴) 

	//*******************************************************************
	// 设置输出切换和通用输出
	BOOL DEVAPI FAR PASCAL PCI1020_OutSwitch(			 // 设置输出切换
								HANDLE hDevice,			 // 设备句柄
								LONG AxisNum,			 // 轴号(PCI1020_XAXIS:X轴,PCI1020_YAXIS:Y轴, PCI1020_ZAXIS:Z轴,PCI1020_UAXIS:U轴) 
								LONG StatusGeneralOut);	 // 状态输出和通用输出选择 PCI1020_STATUS:状态输出 PCI1020_GENERAL:通用输出
	...
	//*******************************************************************
	// 读状态寄存器的位状态
	LONG DEVAPI FAR PASCAL PCI1020_ReadRR(				 // 读RR寄存器
								HANDLE hDevice,			 // 设备句柄
								LONG AxisNum,			 // 轴号(PCI1020_XAXIS:X轴,PCI1020_YAXIS:Y轴, PCI1020_ZAXIS:Z轴,PCI1020_UAXIS:U轴) 
								LONG Num);				 // 寄存器号

	BOOL DEVAPI FAR PASCAL PCI1020_GetRR0Status(		 // 获得主状态寄存器RR0的位状态
								HANDLE hDevice,			 // 设备句柄
								PPCI1020_PARA_RR0 pPara);// RR0寄存器状态

	BOOL DEVAPI FAR PASCAL PCI1020_GetRR1Status(		 // 获得状态寄存器RR1的位状态
								HANDLE hDevice,			 // 设备句柄
								LONG AxisNum,			 // 轴号(PCI1020_XAXIS:X轴,PCI1020_YAXIS:Y轴, PCI1020_ZAXIS:Z轴,PCI1020_UAXIS:U轴) 
								PPCI1020_PARA_RR1 pPara);// RR1寄存器状态			

	BOOL DEVAPI FAR PASCAL PCI1020_GetRR2Status(		 // 获得状态寄存器RR2的位状态
								HANDLE hDevice,			 // 设备句柄
								LONG AxisNum,			 // 轴号(PCI1020_XAXIS:X轴,PCI1020_YAXIS:Y轴, PCI1020_ZAXIS:Z轴,PCI1020_UAXIS:U轴) 
								PPCI1020_PARA_RR2 pPara);// RR2寄存器状态			

	BOOL DEVAPI FAR PASCAL PCI1020_GetRR3Status(		 // 获得状态寄存器RR3的位状态
								HANDLE hDevice,			 // 设备句柄
								PPCI1020_PARA_RR3 pPara);// RR3寄存器状态			

	BOOL DEVAPI FAR PASCAL PCI1020_GetRR4Status(		 // 获得状态寄存器RR4的位状态
								HANDLE hDevice,			 // 设备句柄
								PPCI1020_PARA_RR4 pPara);// RR4寄存器状态

	BOOL DEVAPI FAR PASCAL PCI1020_GetRR5Status(
								HANDLE hDevice,			 // 设备号
								LONG AxisNum,			 // 轴号(PCI1020_XAXIS:X轴,PCI1020_YAXIS:Y轴, PCI1020_ZAXIS:Z轴,PCI1020_UAXIS:U轴) 
								PPCI1020_PARA_RR5 pPara);// RR5寄存器状态

	BOOL DEVAPI FAR PASCAL PCI1020_Reset(HANDLE hDevice);// 软件复位
	//####################### 中断函数 #################################
	// 它由硬件信号的状态变化引起CPU产生中断事件hEventInt。
	BOOL DEVAPI FAR PASCAL PCI1020_InitDeviceInt(HANDLE hDevice, HANDLE hEventInt); // 初始化中断

	BOOL DEVAPI FAR PASCAL PCI1020_ReleaseDeviceInt(HANDLE hDevice); // 释放中断资源
	BOOL DEVAPI FAR PASCAL PCI1020_GetDeviceIntSrc(HANDLE hDevice, BYTE IntSrc[16]); // 获取设备中断位
	BOOL DEVAPI FAR PASCAL PCI1020_ResetDeviceIntSrc(HANDLE hDevice, BYTE IntSrcID); // 释放中断位
	//*******************************************************************
#ifdef __cplusplus
}
#endif

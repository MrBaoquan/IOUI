...
copy %IOUI_SRC_PATH%IOUI-%PLATFORM%-YK2006.dll %IOUI_DST_PATH% /y

if %CONFIGURE% equ Debug (
	xcopy %ProjectDir%Config\YK2006 %IOUI_SRC_PATH%ExternalLibraries\Config\YK2006\ /E /F /Y
) else (
	xcopy %ProjectDir%Config\YK2006 %IOUI_DST_PATH%Config\YK2006\ /E /F /Y
)
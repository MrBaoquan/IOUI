...
copy %IOUI_SRC_PATH%IOUI-%PLATFORM%-SLDS-D10.dll %IOUI_DST_PATH% /y

if %CONFIGURE% equ Debug (
	xcopy %ProjectDir%Config\SLDS-D10 %IOUI_SRC_PATH%ExternalLibraries\Config\SLDS-D10\ /E /F /Y
) else (
	xcopy %ProjectDir%Config\SLDS-D10 %IOUI_DST_PATH%Config\SLDS-D10\ /E /F /Y
)
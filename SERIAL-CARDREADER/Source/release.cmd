...
copy %IOUI_SRC_PATH%IOUI-%PLATFORM%-SERIAL-CARDREADER.dll %IOUI_DST_PATH% /y

if %CONFIGURE% equ Debug (
	xcopy %ProjectDir%Config\SERIAL-CARDREADER %IOUI_SRC_PATH%ExternalLibraries\Config\SERIAL-CARDREADER\ /E /F /Y
) else (
	xcopy %ProjectDir%Config\SERIAL-CARDREADER %IOUI_DST_PATH%Config\SERIAL-CARDREADER\ /E /F /Y
)

...
copy %IOUI_SRC_PATH%IOUI-%PLATFORM%-SERIAL-IOFE.dll %IOUI_DST_PATH% /y

if %CONFIGURE% equ Debug (
	xcopy %ProjectDir%Config\SERIAL-IOFE %IOUI_SRC_PATH%ExternalLibraries\Config\SERIAL-IOFE\ /E /F /Y
) else (
	xcopy %ProjectDir%Config\SERIAL-IOFE %IOUI_DST_PATH%Config\SERIAL-IOFE\ /E /F /Y
)
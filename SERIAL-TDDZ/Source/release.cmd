...
copy %IOUI_SRC_PATH%IOUI-%PLATFORM%-SERIAL-TDDZ.dll %IOUI_DST_PATH% /y

if %CONFIGURE% equ Debug (
	xcopy %ProjectDir%Config\SERIAL-TDDZ %IOUI_SRC_PATH%ExternalLibraries\Config\SERIAL-TDDZ\ /E /F /Y
) else (
	xcopy %ProjectDir%Config\SERIAL-TDDZ %IOUI_DST_PATH%Config\SERIAL-TDDZ\ /E /F /Y
)
...
copy %IOUI_SRC_PATH%IOUI-%PLATFORM%-USB840.dll %IOUI_DST_PATH% /y

if %PLATFORM% equ Win64 (
 copy %IOUI_SRC_CORE_PATH%libusb0.dll %IOUI_DST_CORE_PATH% /y
) else (
 copy %IOUI_SRC_CORE_PATH%libusb0_x86.dll %IOUI_DST_CORE_PATH%	/y
)
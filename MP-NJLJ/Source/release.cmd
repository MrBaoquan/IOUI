...
if %CONFIGURE% equ Debug (
	xcopy %ProjectDir%Config\MP-NJLJ %IOUI_SRC_PATH%ExternalLibraries\Config\MP-NJLJ\ /E /F /Y
) else (
	xcopy %ProjectDir%Config\MP-NJLJ %IOUI_DST_PATH%Config\MP-NJLJ\ /E /F /Y
)
...
#pragma comment(lib,"SD_DataCollect.lib")
...
{
	std::string _path = DevelopHelper::Paths::Instance().GetModuleDir() + "Core\\SD_DataCollect.dll";
	auto _module = LoadLibraryA(_path.data());
	DataCollect::Software(ERunCondition::ERC_START);
    return 1;
}

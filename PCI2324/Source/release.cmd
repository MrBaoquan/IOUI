...
copy %IOUI_SRC_PATH%IOUI-%PLATFORM%-PCI2324.dll %IOUI_DST_PATH% /y

if %PLATFORM% equ Win64 (
 copy %IOUI_SRC_CORE_PATH%PCI2324_64.dll %IOUI_DST_CORE_PATH% /y
) else (
 copy %IOUI_SRC_CORE_PATH%PCI2324_32.dll %IOUI_DST_CORE_PATH%	/y
)

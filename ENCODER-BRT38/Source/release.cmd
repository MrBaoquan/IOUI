...
copy %IOUI_SRC_PATH%IOUI-%PLATFORM%-ENCODER-BRT38.dll %IOUI_DST_PATH% /y

if %CONFIGURE% equ Debug (
	xcopy %ProjectDir%Config\ENCODER-BRT38 %IOUI_SRC_PATH%ExternalLibraries\Config\ENCODER-BRT38\ /E /F /Y
) else (
	xcopy %ProjectDir%Config\ENCODER-BRT38 %IOUI_DST_PATH%Config\ENCODER-BRT38\ /E /F /Y
)